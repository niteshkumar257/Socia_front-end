...
const FollowersCard = () => {
  ...
  const followoUserAction = (userId_to_follow) => {
    ...
    if (I_am_following) {
      axios
        .put(`${base_url}/user/${userId_to_follow}/unfollow`, {
      ...
      axios
        .put(`${base_url}/user/${userId_to_follow}/follow`, {
          currentUserId: userId,
        })
        .then((res) => {
          console.log(res);
            ...
            !follower.followers.includes(userId) && (
              <div key={id} className="follower">
                <div>
                  ...
                  : 
                    <img
                      src={`${base_url}/images/${follower?.profilePicture}`}
                      alt=""
                ...
                <button
                  ...
                  onClick={() => followoUserAction(follower?._id)}
                >
